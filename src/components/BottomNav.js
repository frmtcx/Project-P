window.App.BottomNav = () => {
    ...
    return (
        <nav className="absolute bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-6 pb-6 pt-3 z-50 flex justify-between items-end shadow-[0_-5px_20px_rgba(0,0,0,0.02)]">
            ...
            <button onClick={() => navigate('/chats')} className={`flex flex-col items-center gap-1 p-2 rounded-xl transition ${isActive('/chats') ? 'text-primary bg-red-50' : 'text-gray-400 hover:text-gray-600'}`}>

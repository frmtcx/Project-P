...
window.App.Header = ({ title, subtitle, showBack, onBack, rightIcon = "more_vert" }) => {
    ...
    return (
        <header className="bg-surface-light dark:bg-surface-dark px-4 pt-12 pb-3 sticky top-0 z-40 border-b border-border-light dark:border-border-dark flex items-center justify-between shrink-0">

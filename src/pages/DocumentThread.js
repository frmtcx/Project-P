        ...
        <div className="bg-background-light dark:bg-background-dark text-text-primary-light dark:text-text-primary-dark h-screen flex flex-col">
            ...
            <main className="flex-1 overflow-y-auto p-4 space-y-6 bg-background-light dark:bg-background-dark pb-28">
                ...
                <div className="space-y-6">
                    <div className="flex flex-col items-center gap-1 opacity-70"><div className="h-6 w-px bg-border-light dark:border-border-dark mb-1"></div><div className="flex items-center gap-2"><span className="material-icons-round text-sm text-text-secondary-light">history_edu</span><span className="text-xs font-medium text-text-secondary-light">Signing request created by You</span></div><span className="text-[10px] text-text-secondary-light">Mon, 10:00 AM</span></div>
                    <div className="flex flex-col items-end gap-1">
                        ...
                        <span className="text-[10px] text-text-secondary-light mr-1">10:05 AM</span>
                    </div>
                </div>
            </main>
